...
Weiterhin teilen sich SOA Services häufig Datenbanken, in der Welt der Microservices ist dies hingegen nicht verbreitet. SOA scheint zudem nicht klar genug definiert zu sein.~\cite[vgl.][]{Fowler:Intro} Daher ist es ratsam einen klarer definierten Begriff, wie den der Microserice Architektur anzustreben.~\cite[][]{Fowler:Intro}
...
Wie bei jedem Architekturstil, gibt es sowogl Vorzüge, als auch Nachteile der Microservice Architektur.~\cite[vgl.][]{Fowler:Guide}
...
Interessant ist es hier auch auf die Teamstruktur einzugehen. 

- großes Unternehmen -> mehrere Teams
- mehrere Team aber nur eine Codebase -> Kacke
- Aufsplittung notwendig
- Conways Law: Teams so strukturieren, wie der Code aussehen soll
