...
Weiterhin ermöglichen separate Services auch das separate Skalieren der Anwendung. Bei Monolithen beschränkt sich die Skalierung im Allgemeinen auf Load Balancing~\footcite[vgl.][]{infaktuell}. Hierzu wird eine Anwendung auf mehrere Server dupliziert. Die Anwendungsreplikation sind funktional identisch. Ein Load Balancer verteilt dann die ankommenden Requests auf verschiedene Server. Diese verteilte Last ist aber unabhängig von den einzelnen Anwendungsteilen. Diese können eine unterschiedliche Individuallast haben, dies kann jedoch über den Load Balancer nicht betrachtet werden. 
